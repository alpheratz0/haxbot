...
export const setAvatarsCommand = new SuperUserCommand('setavatars', ({ room, args, sender }: GameCommandContext) => {
    ...
    room.sendAnnouncement(LanguageProvider.get('Avatars updated.'), sender.id, colors.superuser);
});